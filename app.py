...
# 커뮤니티 navigation bar가 역할별 페이지와 숨김 상세 페이지를 함께 라우터에 등록한다.
# 로그아웃하면 다시 로그인 페이지만 등록되므로 이전 역할의 메뉴와 URL 접근도 제거된다.
if auth_user is None:
    ...
    # 파일 경로가 아니라 상단 navbar 라우터에 등록된 StreamlitPage 객체 자체가 있어야
